class HotspotRegistrationsController < ApplicationController
  ...
  def new
    ...
    Rails.logger.info "--- Checking MAC #{params[:id]}"
    ...
    respond_to do |format|
      if @hotspot_registration.try(:authorized?)
        ...
        Rails.logger.info "--- Registering MAC #{params[:id]}..."
  ...
  def temporary_authorization
    Rails.logger.info "------ temporary auth of MAC #{params[:id]}..."
